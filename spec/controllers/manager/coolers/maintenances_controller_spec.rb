...
RSpec.describe Manager::Coolers::MaintenancesController, type: :controller do
  ...
  describe 'GET #index' do
    it 'assigns all maintenances as @maintenances' do
      get :index, params: { cooler_id: cooler.id }
  ...
  describe 'GET #index with search' do
    it 'returns the maintenances searched correctly' do
      maintenance1 = create(:maintenance,
                            date: Date.strptime('31-01-2024', '%d-%m-%Y'), cooler: cooler, company: admin_user.company)
      maintenance2 = create(:maintenance,
                            date: Date.strptime('01-02-2024', '%d-%m-%Y'), cooler: cooler, company: admin_user.company)
  ...
  describe 'GET #show' do
    it 'assigns the requested maintenance as @maintenance' do
      get :show, params: { id: maintenance.id, cooler_id: cooler.id }
  ...
  describe 'GET #new' do
    it 'assigns a new maintenance as @maintenance' do
      get :new, params: { cooler_id: cooler.id }
  ...
  describe 'GET #edit' do
    it 'assigns the requested maintenance as @maintenance' do
      get :edit, params: { id: maintenance.id, cooler_id: cooler.id }
      expect(assigns(:maintenance)).to eq(maintenance)
    end
  end
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new Maintenance' do
        expect do
          post :create, params: { maintenance: valid_attributes, cooler_id: cooler.id }
        end.to change(Maintenance, :count).by(1)
      end

      it 'redirects to the created maintenance' do
        post :create, params: { maintenance: valid_attributes, cooler_id: cooler.id }
        expect(response).to redirect_to(manager_cooler_maintenance_path(cooler, Maintenance.last))
      end
    end

    context 'with invalid params' do
      it 're-renders the "new" template' do
        post :create, params: { maintenance: invalid_attributes, cooler_id: cooler.id }
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      it 'updates the requested maintenance' do
        put :update,
            params: { id: maintenance.id, maintenance: valid_attributes, cooler_id: cooler.id }
        maintenance.reload
      ...
      it 'redirects to the maintenance' do
        put :update,
            params: { id: maintenance.id, maintenance: valid_attributes, cooler_id: cooler.id }
        expect(response).to redirect_to(manager_cooler_maintenance_path(cooler, maintenance))
      end
    end
    ...
    context 'with invalid params' do
      it 're-renders the "edit" template' do
        put :update,
            params: { id: maintenance.id, maintenance: invalid_attributes, cooler_id: cooler.id }
  ...
  describe 'DELETE #destroy' do
    ...
    it 'redirects to the maintenances list' do
      delete :destroy, params: { id: maintenance.id, cooler_id: cooler.id }
      expect(response).to redirect_to(manager_cooler_maintenances_path(cooler))
    end
  end
end
